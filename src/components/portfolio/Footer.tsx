    ...
    <footer className="relative pt-16 pb-8 px-6">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8 mb-10">
          <div>
            <h3 className="text-2xl font-display font-bold text-gradient mb-3">Devi Sri R</h3>
            ...
            <div className="flex gap-3">
              {[FaLinkedin, FaGithub, FaXTwitter].map((Icon, i) => (
                <a
                  key={i}
                  href="#"
                  className="w-10 h-10 rounded-xl bg-muted/50 hover:bg-gradient-primary hover:text-primary-foreground flex items-center justify-center transition-all hover:scale-110"
                >
                  <Icon size={16} />
                </a>
              ))}
