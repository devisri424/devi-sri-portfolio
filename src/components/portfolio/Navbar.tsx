      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="md:hidden glass mt-3 mx-6 rounded-2xl overflow-hidden"
          >
              ...
              {links.map((l) => (
                <li key={l.href}>
                  <a
                    ...
                    className="block px-4 py-2 rounded-lg hover:bg-muted/50 text-muted-foreground hover:text-primary transition-colors"
                  >
                    {l.label}
                  </a>
                </li>
