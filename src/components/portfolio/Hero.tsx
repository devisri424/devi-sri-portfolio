...
export default function Hero() {
  return (
    ...
    >
      ...
      <div
        className="blob w-[600px] h-[600px] bg-secondary/30 bottom-0 -right-32 animate-blob"
        style={{ animationDelay: "5s" }}
      />
      <div
        className="blob w-[400px] h-[400px] bg-accent/30 top-1/2 left-1/2 animate-blob"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="text-muted-foreground mb-8 max-w-lg italic">
            "Passionate about Machine Learning, Python, and AI-powered
            solutions."
          </p>
        ...
        >
          <div className="relative w-80 h-80 md:w-96 md:h-96">
            ...
            <div
              className="absolute inset-4 rounded-full border border-secondary/30 animate-spin-slow"
              style={{
            ...
            <div
              className="absolute inset-10 rounded-full border border-accent/20 animate-spin-slow"
